...
|---|---|---|---|---|
| 2026-06-16 | **★★ W11 OVERNIGHT-BETA premium — CERTIFIED-KEEP (research) → AUCTION-COST-GATED before capital. The program's first real edge.** | CERTIFIED on **18mo / 378d, 15 non-overlapping rebalances, top-200 liquid stocks** (`2026-06-16-w11-overnight-beta/certify_*`). The Hendershott-Livdan-Rösch split HOLDS: high-minus-low-beta L/S **+35 bps/day OVERNIGHT (80% of rebalances +) vs −1.7 INTRADAY**, full-sample bootstrap CI [+14.8,+55.1] excludes 0; canary clean (beta-permute → −0.5, straddles). **DECISIVE confound control: excluding all 14 crypto/AI gappers (COIN/MARA/HOOD/IONQ/...) moves it only +35→+33 and the OOS gets CLEANER — it is a durable beta-RISK premium, NOT the gap regime.** Verified by the Director vs certify_results.json. (The 126d +75 was the high-speculation tail; +35 on 18mo is the durable level.) | spread-net **+35→+32 bps/day** (CI>0); **but OOS net INCLUDING a 5bps MOO/MOC auction stress CI STRADDLES zero** ([−1.1,+43.5] spec-excl; [−8.2,+47.3] full) — the economic edge hinges ENTIRELY on real auction slippage being < ~5bps. Turnover ~18% (low). | **PROMOTE to a PAPER container (the right tool — it MEASURES the real MOO/MOC auction slippage the backtest can only model).** Gate before any capital: (1) paper-confirm the +20-35bps overnight net survives REAL auction fills; (2) watch the regime-conditionality (2025-H1 showed NO split — overnight +25 ≈ intraday +25 in that bull half; 2025-H2 +54/−17 and 2026-H1 +26 are clean); (3) add rebalances as history accrues. CERTIFIED at research; auction-cost-GATED at capital. |
