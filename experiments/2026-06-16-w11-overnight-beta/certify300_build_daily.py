"""Build per-(symbol,date) daily RTH bars for the W11 FULL300 certification.

Identical construction to certify_build_daily.py (same RTH window, same UTC time handling,
same >=378-partition depth filter so depths are never mixed). Writes a SEPARATE output file
(certify300_daily.parquet) so the original 168-name certify_daily.parquet is never overwritten.
"""
...
OUT = "/app/experiments/2026-06-16-w11-overnight-beta/certify300_daily.parquet"
